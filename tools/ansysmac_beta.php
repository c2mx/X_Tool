...
?>
        <form action="" method="post">
            ...
            <div class="row mb-3 mt-3">
                <div class="col-md-2">
                    <div class="form-check">
                        <input name="loadkpnum" class="form-check-input" type="radio" id="load1" value="1" checked>
                        <label class="form-check-label" for="load1">1点加载</label>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-check">
                        <input name="loadkpnum" class="form-check-input" type="radio" id="load4" value="4">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="kp1" value="1">
                <input type="text" class="form-control" name="kp2" value="2">
                <input type="text" class="form-control" name="kp3" value="3">
                <input type="text" class="form-control" name="kp4" value="4">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text">约束点编号:</span>
                <input type="text" class="form-control" name="node1" value="1">
                <input type="text" class="form-control" name="node2" value="2">
                <input type="text" class="form-control" name="node3" value="3">
                <input type="text" class="form-control" name="node4" value="4">
                <input type="text" class="form-control" name="node5" value="5">
                <input type="text" class="form-control" name="node6" value="6">
                <input type="text" class="form-control" name="node7" value="7">
                <input type="text" class="form-control" name="node8" value="8">
            </div>

            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" id="fix" name="fix" value="1">
                <label class="form-check-label" for="fix">节点是否约束了旋转</label>
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text">垂直力</span>
                <input type="text" class="form-control" placeholder="0" name="fv">
                <span class="input-group-text">t</span>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">水平力</span>
                <input type="text" class="form-control" placeholder="0" name="fs">
                <span class="input-group-text">t</span>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">弯矩</span>
                <input type="text" class="form-control" placeholder="0" name="m">
                <span class="input-group-text">t.m</span>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">扭矩</span>
                <input type="text" class="form-control" placeholder="0" name="mk">
                <span class="input-group-text">t.m</span>
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text">扭矩力</span>
                <input type="text" class="form-control" placeholder="0" name="fmk">
                <span class="input-group-text">t</span>
            </div>

            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" id="rf" name="rf" value="1" checked>
                <label class="form-check-label" for="rf">提取节点反力</label>
            </div>

            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" id="rm" name="rm" value="1">
                <label class="form-check-label" for="rm">提取节点反弯矩</label>
            </div>

            <div class="form-check form-switch mb-3">
                <input class="form-check-input" type="checkbox" id="af" name="af" value="1">
                <label class="form-check-label" for="af">提取杆件轴力</label>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="elem1" value="1">
                <input type="text" class="form-control" name="elem2" value="2">
                <input type="text" class="form-control" name="elem3" value="3">
                <input type="text" class="form-control" name="elem4" value="4">
                <input type="text" class="form-control" name="elem5" value="5">
                <input type="text" class="form-control" name="elem6" value="6">
                <input type="text" class="form-control" name="elem7" value="7">
                <input type="text" class="form-control" name="elem8" value="8">
            </div>
            <div class="row">
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="dfx" name="dfx" value="1">
                        <label class="form-check-label" for="dfx">输出整体X向位移云图</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="dfy" name="dfy" value="1">
                        <label class="form-check-label" for="dfy">输出整体y向位移云图</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="dfz" name="dfz" value="1">
                        <label class="form-check-label" for="dfz">输出整体z向位移云图</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="dftotal" name="dftotal" value="1">
                        <label class="form-check-label" for="dftotal">输出整体合位移云图</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="stotal" name="stotal" value="1">
                        <label class="form-check-label" for="stotal">输出整体合应力云图</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="cpnx">输出组件CPN X向位移</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="cpny" name="cpny" value="1">
                        <label class="form-check-label" for="cpny">输出组件CPN y向位移</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="cpnz" name="cpnz" value="1">
                        <label class="form-check-label" for="cpnz">输出组件CPN z向位移</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="cpnt" name="cpnt" value="1">
                        <label class="form-check-label" for="cpnt">输出组件CPN 合位移</label>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="cpnst" name="cpnst" value="1">
                        <label class="form-check-label" for="cpnst">输出组件CPN 合应力</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="d-grid col mx-auto">
                    <button type="reset" class="btn btn-danger btn-lg text-nowrap">重置页面</button>
                </div>
                <div class="d-grid col mx-auto">
