...
window.onload = function () {
  ...
  for (i = 0; i < inputtext.length; i++) {
    inputtext[i].addEventListener("click", function () {
      this.focus();
    });
  ...
  document
    .querySelector('input[name="macname"]')
  ...
  document
    .querySelector('input[name="kp1"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d]/g, "");
    });
  document
    .querySelector('input[name="node1"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d]/g, "");
    });
  document
    .querySelector('input[name="node2"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d]/g, "");
    });
  ...
  document
    .querySelector('input[name="fv"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d^\.]+/g, "");
    });
  document
    .querySelector('input[name="fs"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d^\.]+/g, "");
    });
  document
    .querySelector('input[name="m"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d^\.]+/g, "");
    });
  document
    .querySelector('input[name="mk"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d^\.]+/g, "");
    });
  document
    .querySelector('input[name="fmk"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d^\.]+/g, "");
    });
  document
    .querySelector('input[name="elem1"]')
    .addEventListener("input", function () {
      this.value = this.value.replace(/[^\d]/g, "");
    });
  ...
  document
    .querySelector('input[id="load1"]')
    .addEventListener("change", changekp);
  document
    .querySelector('input[id="load4"]')
    .addEventListener("change", changekp4);
  document
    .querySelector('select[name="ysnum"]')
    .addEventListener("change", function () {
      changeys(this);
    });
  document
    .querySelector('input[name="fix"]')
    .addEventListener("change", function () {
      ysxz(this);
    });
  document
    .querySelector('input[name="af"]')
    .addEventListener("change", function () {
      zhouli(this);
    });
  document
    .querySelector('select[name="afnum"]')
    .addEventListener("change", function () {
      changezl(this);
    });
  document
    .querySelector('select[name="cpnum"]')
    .addEventListener("change", function () {
      changecp(this);
    });
  document
    .querySelector('input[name="ckfv"]')
    .addEventListener("change", function () {
      chckfv(this);
    });
  document
    .querySelector('input[name="ckfs"]')
    .addEventListener("change", function () {
      chckfs(this);
    });
  document
    .querySelector('input[name="ckm"]')
    .addEventListener("change", function () {
      chckm(this);
    });
  document
    .querySelector('input[name="ckmk"]')
    .addEventListener("change", function () {
      chckmk(this);
    });
  document
    .querySelector('input[name="ckfmk"]')
    .addEventListener("change", function () {
      chckfmk(this);
    });
  document
    .querySelector('input[id="ca360"]')
    .addEventListener("change", chca360);
